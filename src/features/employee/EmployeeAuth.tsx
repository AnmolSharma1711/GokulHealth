          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-white/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all font-medium text-slate-900 tracking-widest"
                value={mpin}
